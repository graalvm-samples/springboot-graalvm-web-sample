 ...
 * <p>
 * If {@link MapperScan} is used, or a
...
//        "com.fushun.fund.dao.mapper"
//}, sqlSessionTemplateRef = "sqlSessionTemplateSecond")
@MapperScan(basePackages = "com.fushun.framework.sample.mybatis.mapper", sqlSessionTemplateRef = "sqlSessionTemplateSecond")

//@ConditionalOnClass({SqlSessionFactory.class, SqlSessionFactoryBean.class})
//@ConditionalOnSingleCandidate(DataSource.class)
//@EnableConfigurationProperties(MybatisPlusProperties.class)
//@AutoConfigureAfter({DataSourceAutoConfiguration.class, MybatisPlusLanguageDriverAutoConfiguration.class})
public class MybatisPlusSecondConfiguration implements InitializingBean {
    ...
    public MybatisPlusSecondConfiguration(@Qualifier("mybatisPlusPropertiesSecond") MybatisPlusProperties properties,
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("secondDataSource") DataSource firstDataSource) throws Exception {
