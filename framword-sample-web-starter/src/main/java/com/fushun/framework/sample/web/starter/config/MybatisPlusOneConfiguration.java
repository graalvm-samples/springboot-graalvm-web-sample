...
@MapperScan(basePackages = "com.fushun.framework.sample.mybatis.mapper", sqlSessionTemplateRef = "sqlSessionTemplateOne")
public class MybatisPlusOneConfiguration implements InitializingBean {
    ...
    public MybatisPlusOneConfiguration(@Qualifier("mybatisPlusPropertiesOne") MybatisPlusProperties properties,
    ...
    @Primary
    public SqlSessionFactory sqlSessionFactory(@Qualifier("firstDataSource") DataSource firstDataSource) throws Exception {
